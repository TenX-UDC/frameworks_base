...
import com.android.internal.util.tenx.DeviceConfigUtils;
...
public final class Settings {
	...
	public static final String NOTIFICATION_MATERIAL_DISMISS_ICON_STYLE = "notification_material_dismiss_icon_style";
        ...
        /**
         * Settings dashboard arrow & background
         * @hide
         */
        public static final String SETTINGS_DASHBOARD_BACKGROUND_ARROW = "settings_dashboard_background_arrow";

        /**
         * Settings dashboard arrow color
         * @hide
         */
        public static final String SETTINGS_DASHBOARD_ARROW_COLOR = "settings_dashboard_arrow_color";
         ...
         * @hide
         */
        public static final String SETTINGS_DASHBOARD_ICON_COLOR = "settings_dashboard_icon_color";
	...
	public static final String SETTINGS_TENX_DASHBOARD_BATTERY_LEVEL_COLOR_TWENTY = "settings_tenx_dashboard_battery_level_color_twenty";
        ...
        /**
         * Settings TenX dashboard weather type
         * @hide
         */
	...
	public static final String SETTINGS_TENX_DASHBOARD_BATTERY_LEVEL_COLOR_ALPHA = "settings_tenx_dashboard_battery_level_color_alpha";
         ...
         * @hide
         */
        public static final String DISPLAY_SETTINGS_HOMEPAGE_AVATAR = "display_settings_homepage_avatar";
