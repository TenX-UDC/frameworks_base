...
public class AmbientIndicationContainer extends AutoReinflateContainer implements
    ...
    public void initializeView(CentralSurfaces centralSurfaces, Handler handler, WakeLockLogger wakeLockLogger) {
    ...
    private void initializeMedia() {
        ...
        mMediaWakeLock = new SettableWakeLock(WakeLock.createPartial(mContext, mWakeLockLogger, "media"),
                "media");
    }
    ...
    private boolean shouldShow() {
        ...
        final NotificationLockscreenUserManager lockscreenManager =
                mCentralSurfaces.getNotificationLockscreenUserManager();
        boolean filtered = lockscreenManager.shouldShowLockscreenNotifications();
