...
public class UdfpsKeyguardViewLegacy extends UdfpsAnimationView {
    ...
    public UdfpsKeyguardViewLegacy(Context context, @Nullable AttributeSet attrs) {
        ...
        mPackageInstalled = com.android.internal.util.tenx.Utils.isPackageInstalled(
                mContext, "com.tenx.udfps.icons");
    }
    ...
    void updateColor() {
        ...
        mTextColorPrimary = Color.WHITE;
        final int backgroundColor = Color.parseColor("#99000000");
