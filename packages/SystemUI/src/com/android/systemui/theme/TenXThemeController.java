...
public class TenXThemeController {

    private static final String TAG = "TenXThemeController";
    private final ContentResolver mContentResolver;
    private final Handler mBackgroundHandler;
    private Context mContext;

    public TenXThemeController(Context context, Handler backgroundHandler) {
    ...
    public void observeSystemSettings(Runnable reevaluateSystemThemeCallback) {
        observeSystemSettings(reevaluateSystemThemeCallback, TenXSettingsConstants.SYSTEM_SETTINGS_KEYS);
    }
