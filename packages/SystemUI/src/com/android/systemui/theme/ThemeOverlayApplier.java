...
public class ThemeOverlayApplier implements Dumpable {
    ...
    @VisibleForTesting
    static final String OVERLAY_CATEGORY_SETTINGS_CARDS =
            "android.theme.customization.settings_cards";
    @VisibleForTesting
    static final String OVERLAY_CATEGORY_SETTINGS_HOMEPAGE_AVATAR =
            "android.theme.customization.settings.homepage_avatar";
    @VisibleForTesting
    ...
    static final List<String> THEME_CATEGORIES = Lists.newArrayList(
            ...
            OVERLAY_CATEGORY_SETTINGS_CARDS,
            OVERLAY_CATEGORY_SETTINGS_HOMEPAGE_AVATAR);
    ...
    public ThemeOverlayApplier(OverlayManager overlayManager,
        ...
        mCategoryToTargetPackage.put(OVERLAY_CATEGORY_SETTINGS_CARDS, SETTINGS_PACKAGE);
        mCategoryToTargetPackage.put(OVERLAY_CATEGORY_SETTINGS_HOMEPAGE_AVATAR, SETTINGS_PACKAGE);
