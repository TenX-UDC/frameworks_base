...
public class ThemeOverlayController implements CoreStartable, Dumpable {
    ...
    public void start() {
        ...
        mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.DEFAULT_QS_TILE_CORNER_RADIUS),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
       ...
       mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.DEFAULT_QS_TILE_STYLES),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
       ...
       mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.SETTINGS_DASHBOARD_BACKGROUND_SHOWN),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
       ...
       mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.SETTINGS_DASHBOARD_BACKGROUND_ARROW),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
       ...
       mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.SETTINGS_DASHBOARD_ARROW_COLOR),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
       ...
       mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.SETTINGS_DASHBOARD_BACKGROUND_STYLE),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
       ...
       mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.SETTINGS_DASHBOARD_BACKGROUND_COLOR),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
       ...
       mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.SETTINGS_DASHBOARD_BACKGROUND_STROKE_WIDTH),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
       ...
       mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.SETTINGS_DASHBOARD_BACKGROUND_GRADIENT_START_COLOR),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
       ...
       mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.SETTINGS_DASHBOARD_BACKGROUND_GRADIENT_END_COLOR),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
       ...
       mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.SETTINGS_DASHBOARD_ICON_COLOR),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
       ...
       mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.SETTINGS_DASHBOARD_IOCON_STYLES),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
       ...
       mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.SETTINGS_DASHBOARD_BACKGROUND_SIZE),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
       ...
       mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.USE_CUSTOM_STATUSBAR_PADDING_START),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
       ...
       mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.CUSTOM_STATUSBAR_PADDING_START),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
       ...
       mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.USE_CUSTOM_STATUSBAR_PADDING_END),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
       ...
       mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.CUSTOM_STATUSBAR_PADDING_END),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
       ...
       mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.USE_CUSTOM_STATUSBAR_HEIGHT),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
       ...
       mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.CUSTOM_STATUSBAR_HEIGHT),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
       ...
       mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.USE_DUAL_STATUSBAR_MOD),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
